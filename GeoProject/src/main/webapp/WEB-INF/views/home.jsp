			...
			<div class="row gx-5 align-items-center">
				<div class="col-xxl-7">
					<div id="map" style="width: 100%; height: 300px;"></div>
						<p class="lead rounded text-dark fs-5 fw-light"
							style="text-shadow: 1px 1px 1px white; background-color: rgba(255, 255, 255, 0.5);">
							현재 사용자 위치를 기준으로 선택한 병원 내 부서 및 편의시설로 가는 길을 안내하는 가이드입니다.</p>
						<div
							class="text-center InternetIssue gap-3 d-sm-flex Sans justify-content-sm-center">
							<a href="testpage"
								class="bg-gradient-primary-to-secondary btn btn-lg fs-4 fw-bolder"><span></span>
